...
def over_game(ai_settings,screen):

    text = pygame.font.SysFont(ai_settings.over_game_textFont, ai_settings.over_game_textSize)
    text_over_game = text.render(ai_settings.over_game_text, 1, ai_settings.over_game_textColor,ai_settings.over_game_textBgColor)
